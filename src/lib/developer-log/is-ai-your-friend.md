...
slug: 'is-ai-your-friend'
publishedAt: '2024-04-01'
summary: 'AI is rapidly changing the landscape of programmers. Many are worried about the future of jobs as new models are released each week. It has been the biggest shift since the Industrial Revolution.'
type: 'Field Note'
...
topics:
  ...
  - 'Product design'
cover:
  src: '/developer-log/is-ai-your-friend/cover.png'
  alt: 'Person touching a robotic hand'
  caption: 'Photo by Andy Kelly via Unsplash'
---
...
Cover photo by [Andy Kelly](https://unsplash.com/@askkell) on [Unsplash](https://unsplash.com/photos/photo-of-girl-laying-left-hand-on-white-digital-robot-0E_vhMVqL9g).
