...
<Seo title="Devote Terms — Code Carton" description="Terms and conditions for Devote." />
<div class="legal-document md:px-20 mx-auto max-w-4xl mt-10">
	<strong>Terms &amp; Conditions</strong><br />
	<p>
		These terms and conditions apply to the Devote app (hereby referred to as "Application") for
		mobile devices that was created by Code Carton, LLC (hereby referred to as "Service Provider")
	...
	<div>
		...
		<p>
			...
			translate the Application into other languages, or create derivative versions are not
			permitted. All trademarks, copyrights, database rights, and other intellectual property rights
	...
	<br />
	<p>These terms and conditions are effective as of 2026-04-20</p>
	...
	<p>
		...
		to contact the Service Provider at hello@codecarton.com.
	</p>
	<hr />
	<p>
